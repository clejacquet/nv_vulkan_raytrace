...
set(RESOURCE_DIRECTORY "${BASE_DIRECTORY}/rtnv/resources")
add_definitions(-DRESOURCE_DIRECTORY="${RESOURCE_DIRECTORY}/")

include_directories(${BASE_DIRECTORY}/rtnv)
include_directories(${BASE_DIRECTORY}/external)

if (WIN32)
  include_directories(${BASE_DIRECTORY}/external/glfw3/include)
else() 
...
set(CMAKE_MODULE_PATH ${BASE_DIRECTORY}/rtnv/cmake ${BASE_DIRECTORY}/rtnv/cmake/find)
...
macro(_add_package_ZLIB)
  if(EXISTS ${BASE_DIRECTORY}/external/zlib)
    set(ZLIB_ROOT ${BASE_DIRECTORY}/external/zlib)
  endif()
...
macro(_add_package_ImGUI)
  ...
  include_directories(${BASE_DIRECTORY}/rtnv/imgui)
...
macro(_add_package_Sockets)
  ...
  set(SOCKETS_PATH "${BASE_DIRECTORY}/rtnv/nvsockets")
  get_directory_property(hasParent PARENT_DIRECTORY)
  if(hasParent)
...
macro(_add_package_DirectX12)
  ...
  if(DX12SDK_FOUND)
      ...
      include_directories(${BASE_DIRECTORY}/external/d3d12/include)
...
macro(_add_package_OpenCL)
  ...
  if(OpenCL_FOUND)
      ...
      string(FIND ${OpenCL_INCLUDE_DIRS} "external" OFFSET)
      if((OFFSET GREATER -1) AND WIN32 )
        if((ARCH STREQUAL "x86"))
          #set(OPENCL_DLL ${BASE_DIRECTORY}/external/OpenCL/lib/x86/OpenCL.dll)
        else()
          #set(OPENCL_DLL ${BASE_DIRECTORY}/external/OpenCL/lib/x64/OpenCL.dll)
        endif()
      endif()
...
macro(_add_package_NSight)
  ...
  set(USING_NSIGHT)
  include_directories(
      ${BASE_DIRECTORY}/external/NSight
  )
  if(SUPPORT_NVTOOLSEXT)
    link_directories(
        ${BASE_DIRECTORY}/external/NSight
    ...
    LIST(APPEND PACKAGE_SOURCE_FILES 
      ${BASE_DIRECTORY}/rtnv/nvh/nsightevents.h
      ${BASE_DIRECTORY}/external/NSight/nvToolsExt.h
    )
    add_definitions(-DNVP_SUPPORTS_NVTOOLSEXT)
    if(ARCH STREQUAL "x86")
      set(NSIGHT_DLL ${BASE_DIRECTORY}/external/NSight/nvToolsExt32_1.dll)
      set(NSIGHT_LIB ${BASE_DIRECTORY}/external/NSight/nvToolsExt32_1.lib)
    else()
      set(NSIGHT_DLL ${BASE_DIRECTORY}/external/NSight/nvToolsExt64_1.dll)
      set(NSIGHT_LIB ${BASE_DIRECTORY}/external/NSight/nvToolsExt64_1.lib)
    endif()
...
macro(_process_shared_cmake_code)
  ...
  LIST(APPEND COMMON_SOURCE_FILES
      ${BASE_DIRECTORY}/rtnv/resources.h
      ${BASE_DIRECTORY}/rtnv/resources.rc
  )
...
macro(_add_shared_sources_lib)
  ...
  if(NOT HAS_SHARED_SOURCES)
    add_subdirectory(${BASE_DIRECTORY}/rtnv ${CMAKE_BINARY_DIR}/rtnv)
  endif()
  #-----------------------------------------------------------------------------------
