...
void Application::Impl::renderUI()
{
    ...
    {
        ImGui::RadioButton("Point", &m_pushConstant.lightType, 0);
        ImGui::SameLine();
        ImGui::RadioButton("Infinite", &m_pushConstant.lightType, 1);

        ImGui::SliderFloat3("Position", &m_pushConstant.lightPosition.x, -20.f, 20.f);
        ImGui::SliderFloat("Intensity", &m_pushConstant.lightIntensity, 0.f, 150.f);
    }
}
